...
public class RobiSim extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_robi_sim);
        getSupportActionBar().setTitle("RobiSim");
        ...
        bcopy1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(RobiSim.this, "Copy Finished", Toast.LENGTH_LONG).show();
        ...
        buttond1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setData(Uri.parse("tel:*222#"));
                startActivity(intent);

                Toast.makeText(RobiSim.this, "Please Type- #  then Call", Toast.LENGTH_LONG).show();
        ...
        buttond2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Intent.ACTION_DIAL);
                intent.setData(Uri.parse("tel:*140*2*4#"));
                startActivity(intent);
        ...
        buttond3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Intent.ACTION_DIAL);
                intent.setData(Uri.parse("tel:*140*14#"));
                startActivity(intent);
        ...
        buttond4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Intent.ACTION_DIAL);
                intent.setData(Uri.parse("tel:*8444*88#"));
                startActivity(intent);
        ...
        buttond6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Intent.ACTION_DIAL);
                intent.setData(Uri.parse("tel:*222*11#"));
                startActivity(intent);
        ...
        buttond8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Intent.ACTION_DIAL);
                intent.setData(Uri.parse("tel:*8444#"));
                startActivity(intent);

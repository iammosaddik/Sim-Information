...
public class TeletalkSim extends AppCompatActivity {


    TextView ablanceC1, ablanceC2, ablanceC3, ablanceC4, ablanceC5, ablanceC6, ablanceC7, ablanceC8, ablanceC9;
    Button bcopy1, bcopy2, bcopy3, bcopy4, bcopy5, bcopy6, bcopy7, bcopy8, bcopy9, buttond1, buttond2, buttond3, buttond4, buttond5, buttond6, buttond7, buttond8, buttond9;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_teletalk_sim);
        getSupportActionBar().setTitle("TeletalkSim");
        ...
        bcopy1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(TeletalkSim.this, "Copy Finished", Toast.LENGTH_LONG).show();
        ...
        buttond1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.setData(Uri.parse("tel:*152#"));
                startActivity(intent);

                Toast.makeText(TeletalkSim.this, "Please Type- #  then Call", Toast.LENGTH_LONG).show();
        ...
        buttond2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Intent.ACTION_DIAL);
                intent.setData(Uri.parse("tel:*551#"));
                startActivity(intent);

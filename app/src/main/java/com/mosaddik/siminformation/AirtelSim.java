...
public class AirtelSim extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_airtel_sim);
        getSupportActionBar().setTitle("AirtelSim");
        ...
        bcopy1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(AirtelSim.this, "Copy Finished", Toast.LENGTH_LONG).show();
        ...
        buttond1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               intent.setData(Uri.parse("tel:*778#"));
               startActivity(intent);

                Toast.makeText(AirtelSim.this, "Please Type #  then Call", Toast.LENGTH_LONG).show();
        ...
        buttond2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Intent.ACTION_DIAL);
                intent.setData(Uri.parse("tel:*121*6*3#"));
                startActivity(intent);
        ...
        buttond3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Intent.ACTION_DIAL);
                intent.setData(Uri.parse("tel:*778*39#"));
                startActivity(intent);
        ...
        buttond5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Intent.ACTION_DIAL);
                intent.setData(Uri.parse("tel:*778*5#"));
                startActivity(intent);
        ...
        buttond6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Intent.ACTION_DIAL);
                intent.setData(Uri.parse("tel:*778*8#"));
                startActivity(intent);
        ...
        buttond7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Intent.ACTION_DIAL);
                intent.setData(Uri.parse("tel:*778*2#"));
                startActivity(intent);
        ...
        buttond8.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Intent.ACTION_DIAL);
                intent.setData(Uri.parse("tel:*222*13#"));
                startActivity(intent);
        ...
        buttond9.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Intent.ACTION_DIAL);
                intent.setData(Uri.parse("tel:*9#"));
                startActivity(intent);
        ...
        buttond10.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(Intent.ACTION_DIAL);
                intent.setData(Uri.parse("tel:*141*100#"));
                startActivity(intent);
